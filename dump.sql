...
-- Started on 2025-04-22 14:06:10
...
ALTER TABLE public.employment ALTER COLUMN id_employment ADD GENERATED ALWAYS AS IDENTITY (
...
COPY public.employee (id_employee, name, second_name, middle_name) FROM stdin;
...
COPY public.employment (id_employment, "Combined", id_employee, id_post, id_division) FROM stdin;
1	f	1	1	1
2	f	2	2	2
4	t	3	2	1
5	f	4	2	1
...
COPY public.measurement (id_measurement, value_measurement, measurement_number, datetime, quality_protective_layer, id_employment, id_product, id_device, id_place_measurement) FROM stdin;
...
COPY public.measurement_characteristics (id_measurement_characteristics, id_measuring_device_model, id_measuring_value, upper_measurement_range, lower_measurement_range, error_rate, "id_JSON") FROM stdin;
1	1	1	500	100	0.02	nanometers
3	3	1	120	0.5	0.02	nanometers
2	2	1	500	2	0.03	nanometers
\.
...
COPY public.measuring_device (id_measuring_device, device_serial, id_characteristics, date_commissioning, date_verification, repair_date) FROM stdin;
...
COPY public.measuring_device_model (id_measuring_device_model, name, id_manufacturer, weight) FROM stdin;
1	МТП-10П	1	450
2	МТ-2007	2	320
3	Константа К6Ц	4	250
\.
...
ALTER TABLE ONLY public.employment
    ADD CONSTRAINT employment_pkey PRIMARY KEY (id_employment);
...
-- Name: employment fk_employment_division; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: employment fk_employment_employee; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employment
    ADD CONSTRAINT fk_employment_employee FOREIGN KEY (id_employee) REFERENCES public.employee(id_employee);


--
-- TOC entry 4791 (class 2606 OID 16549)
-- Name: employment fk_employment_post; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: measurement_characteristics measurement_characteristics_id_measuring_device_model_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.measurement_characteristics
    ADD CONSTRAINT measurement_characteristics_id_measuring_device_model_fkey FOREIGN KEY (id_measuring_device_model) REFERENCES public.measuring_device_model(id_measuring_device_model);
...
ALTER TABLE ONLY public.measurement
    ADD CONSTRAINT measurement_id_employment_fkey FOREIGN KEY (id_employment) REFERENCES public.employment(id_employment);
...
--
-- TOC entry 4799 (class 2606 OID 16673)
-- Name: measuring_device measuring_device_id_characteristics_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.measuring_device
    ADD CONSTRAINT measuring_device_id_characteristics_fkey FOREIGN KEY (id_characteristics) REFERENCES public.measurement_characteristics(id_measurement_characteristics);


-- Completed on 2025-04-22 14:06:11
